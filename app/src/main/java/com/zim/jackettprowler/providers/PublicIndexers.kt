...
/**
 * RARBG - Legendary tracker (archived, use mirrors/alternatives)
 */
class ProviderRARBG : BaseIndexerProvider() {
    override val id = "rarbg"
    override val name = "RARBG Mirror"
    override val baseUrl = "https://rarbgprx.org"
    override val description = "RARBG alternative/proxy site"
 ...
 */
class ProviderTorlock : BaseIndexerProvider() {
    override val id = "torlock"
    override val name = "Torlock"
    override val baseUrl = "https://www.torlock.com"
    override val description = "Torlock offers verified torrents with anime, movies, TV, music, games, and software"
    ...
    override fun toConfig() = CustomSiteConfig(
        ...
        selectors = selectors(
            ...
            title = "div.tk a b",
            torrentPageUrl = "div.tk a",
            size = "td:nth-child(3)",
            seeders = "td:nth-child(4)",
            leechers = "td:nth-child(5)",
            publishDate = "td:nth-child(2)"
        )
    )
}

/**
 * GloTorrents - Multi-content indexer
 */
class ProviderGloTorrents : BaseIndexerProvider() {
    override val id = "glotorrents"
    override val name = "GloTorrents"
    override val baseUrl = "https://glotorrents.fr"
    override val description = "GloTorrents is a general-purpose torrent site"
    
    override fun toConfig() = CustomSiteConfig(
        id = id,
        name = name,
        baseUrl = baseUrl,
        searchPath = "/search.php?search={query}",
        selectors = selectors(
            container = "div.tt-item",
            title = "h3 a",
            torrentPageUrl = "h3 a",
            magnetUrl = "a[href^='magnet:']",
            size = "span.tt-size",
            seeders = "span.tt-seed",
            leechers = "span.tt-leech"
        )
    )
}

/**
 * SolidTorrents - Multi-search aggregator
 */
class ProviderSolidTorrents : BaseIndexerProvider() {
    override val id = "solidtorrents"
    override val name = "SolidTorrents"
    override val baseUrl = "https://solidtorrents.to"
    override val description = "SolidTorrents aggregates results from multiple sources"
    ...
    override fun toConfig() = CustomSiteConfig(
        ...
        selectors = selectors(
            ...
            title = "h5.title a",
            magnetUrl = "a[href^='magnet:']",
            size = "div.stats span:nth-child(1)",
            publishDate = "div.stats span:nth-child(2)"
        )
    )
}
